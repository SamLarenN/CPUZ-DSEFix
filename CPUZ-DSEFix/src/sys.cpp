	...
	: dwBuildNumber(BuildNumber)
{
	...
	Driver = new cpuz();			// Initialize cpuz.sys IOCTL functions used for reading/writing System Memory

	if (Driver == nullptr)
		throw std::runtime_error("cpuz Class Object Is Not Initialized.");
...
/* Call to cpuz.sys to patch the global system variable */
...
/* Call to cpuz.sys to re enable DSE */
